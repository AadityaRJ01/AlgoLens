...
export default function RevisionReason({ reason, tier, compact = false }) {
  const dotClass = tier ? TIER_META[tier].dotClass : "bg-slate-500";
  ...
  return (
    <div>
      <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Why are you revising this?</p>
      <p className="mt-1 flex items-start gap-1.5 text-sm leading-snug text-slate-300">
