  ...
  return (
    <div>
      ...
      <dl className="mt-1.5 grid grid-cols-3 gap-3 text-sm">
        <div>
          <dt className="text-xs text-neutral-500">Mastery</dt>
          <dd className="font-semibold text-neutral-100">{problem.masteryScore !== null ? `${problem.masteryScore}%` : "—"}</dd>
        </div>
        <div>
          <dt className="text-xs text-neutral-500">Attempts</dt>
          <dd className="font-semibold text-neutral-100">{problem.attempts}</dd>
        </div>
        <div>
          <dt className="text-xs text-neutral-500">Last attempted</dt>
          <dd className="font-semibold text-neutral-100">{problem.lastAttempted || "Never"}</dd>
        </div>
      </dl>
    </div>
  );
