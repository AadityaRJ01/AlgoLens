  ...
  return (
    <div className="min-h-screen bg-[#05060a]">
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        <div className="rounded-xl border border-rose-400/20 bg-neutral-900/60 p-6 text-center space-y-3">
          <h2 className="text-lg font-semibold text-neutral-50">Couldn&apos;t load your dashboard</h2>
